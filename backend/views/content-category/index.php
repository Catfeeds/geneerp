...
$pagesize = isset($get['ContentCategorySearch']['pagesize']) ? $get['ContentCategorySearch']['pagesize'] : '';
$keyword = isset($get['ContentCategorySearch']['keyword']) ? trim($get['ContentCategorySearch']['keyword']) : '';
$status = isset($get['ContentCategorySearch']['status']) ? $get['ContentCategorySearch']['status'] : '';
$home_block = isset($get['ContentCategorySearch']['home_block']) ? $get['ContentCategorySearch']['home_block'] : '';
$model_id = isset($get['ContentCategorySearch']['model_id']) ? $get['ContentCategorySearch']['model_id'] : '';
...
<div class="box box-primary">
    <div class="box-header">
        <div class="pull-left">
            ...
            <?= $form->field($searchModel, 'status')->dropDownList(ContentCategory::getStatus(), ['prompt' => '选择状态', 'value' => $status]) ?>
            <?= $form->field($searchModel, 'home_block')->dropDownList(Util::getStatusOpenClose(), ['prompt' => '选择首页板块', 'value' => $home_block]) ?>
            <?= $form->field($searchModel, 'model_id')->dropDownList(ContentModel::getKeyValueCache(), ['prompt' => '选择模型', 'value' => $model_id]) ?>
        ...
        <div class="pull-right">
            ...
            <?php } ?>
            <?php if (CheckRule::checkRole('content-category/create')) { ?>
    ...
    <div class="box-body">
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'c_model_id',
                    'format' => 'raw',
                    'value' => function($model) {
                        return isset($model->contentModel->c_title) ? $model->contentModel->c_title : '--';
                    },
                ],
                [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function($model) {
                        return ContentCategory::getStatus($model->c_status);
                    },
                ],
                [
                ...
                [
                    ...
                    'buttons' => [
                        'list' => function ($url, $model, $key) {
                            ...
                            'visibleButtons' => [
                                'update' => CheckRule::checkRole('content-category/update'),
                                'delete' => CheckRule::checkRole('content-category/delete')
                            ]
                        ],
                    ],
                ]);
