...
class ShopCart {
    ...
    public function init($user_id = 0) {
        ...
        $this->order_data['order_count'] = 0; //订单商品种类数目
    ...
    public function checkOut($province_id, $delivery_id, $pay_type, $is_invoice = 2, $paid_freight_amount = null, $admin_discount_amount = 0) {
        $order_goods = [];
        $this->order_data['order_count'] = count($this->buy_data);
        if ($this->buy_data) {
        ...
        //优惠金额 
        $this->order_data['promotion_amount'] -= $admin_discount_amount;
        ...
        $this->order_data['order_amount'] = $this->order_data['paid_goods_amount'] + $this->order_data['paid_freight_amount'] + $this->order_data['insured_amount'] + $this->order_data['tax_amount'] - $admin_discount_amount;
     ...
     * @return type
     */
    public function dataFormat($counts) {
        $array = [];
        foreach ($counts as $goods_id => $count) {
            $array[$goods_id]['buy_count'] = $count;
        }
        $this->buy_data = $array;
    }
