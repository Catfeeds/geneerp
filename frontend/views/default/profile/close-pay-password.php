...
<div class="panel panel-default">
    <div class="panel-heading"><i class="glyphicon glyphicon-lock" aria-hidden="true"></i> 关闭支付密码</div>
    <div class="panel-body">
        <form class="form-ajax form-horizontal" action="<?= Url::to(['close-pay-password']) ?>" method="post" autocomplete="off" onsubmit="return false;">
